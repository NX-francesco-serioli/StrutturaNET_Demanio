...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdspMds.Api.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AdspMds.Api.Data.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AdspMds.Api.Data.UserPermission", b =>
                {
                    b.HasOne("AdspMds.Api.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdspMds.Api.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
