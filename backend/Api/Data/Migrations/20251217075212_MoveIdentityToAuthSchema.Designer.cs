...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdSPMdS.DemanioDigitale.Api.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AdSPMdS.DemanioDigitale.Api.Data.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AdSPMdS.DemanioDigitale.Api.Data.UserPermission", b =>
                {
                    b.HasOne("AdSPMdS.DemanioDigitale.Api.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdSPMdS.DemanioDigitale.Api.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
